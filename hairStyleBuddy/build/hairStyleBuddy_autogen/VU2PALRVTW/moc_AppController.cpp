...
#include "../../../src/backend/AppController.h"
...
template <> constexpr inline auto AppController::qt_create_metaobjectdata<qt_meta_tag_ZN13AppControllerE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<AppointmentModel*>(8, 0x80000000 | 9, QMC::DefaultPropertyFlags | QMC::EnumOrFlag | QMC::Constant),
        // property 'services'
        QtMocHelpers::PropertyData<ServiceModel*>(10, 0x80000000 | 11, QMC::DefaultPropertyFlags | QMC::EnumOrFlag | QMC::Constant),
        // property 'salonName'
...
void AppController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->salonNameChanged(); break;
        case 1: _t->markArrived((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->addQuickNote((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->refresh(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AppController::*)()>(_a, &AppController::salonNameChanged, 0))
            return;
    }
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< AppointmentModel* >(); break;
        case 1:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< ServiceModel* >(); break;
        }
    }
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast<AppointmentModel**>(_v) = _t->appointments(); break;
        case 1: *reinterpret_cast<ServiceModel**>(_v) = _t->services(); break;
        case 2: *reinterpret_cast<QString*>(_v) = _t->salonName(); break;
        default: break;
        }
    }
}
...
// SIGNAL 0
void AppController::salonNameChanged()
{
